...
const data = [
    ...
    [
        "003", "中心公司", "A001", "2019/12/11", "aioverg",
        [
    ...
    [
        "004", "熵增公司", "A001", "2019/12/11", "aioverg",
        [
    ...
    [
        "005", "消元公司", "A001", "2019/12/11", "aioverg",
        [
    ...
    [
        "006", "聚合公司", "A001", "2019/12/11", "aioverg",
        [
    ...
    [
        "007", "梯度公司", "A001", "2019/12/11", "aioverg",
        [
    ...
    [
        "008", "换元公司", "A001", "2019/12/11", "aioverg",
        [
    ...
    [
        "009", "弗洛公司", "A001", "2019/12/11", "aioverg",
        [
            ["西瓜", "A0005", "千克", "1.00", "1.00", "10", "100"],
            ["香蕉", "A0004", "千克", "2.50", "2.50", "10", "100"],
        ],
    ...
    [
        "010", "还原公司", "A001", "2019/12/11", "aioverg",
        [
            ["石榴", "A0009", "千克", "3.00", "3.00", "10", "100"],
            ["西瓜", "A0005", "千克", "1.00", "1.00", "10", "100"],
        ],
    ...
    [
        "011", "极简公司", "A001", "2019/12/11", "aioverg",
        [
            ["桃子", "A0003", "千克", "6.00", "6.00", "10", "100"],
            ["柠檬", "A0010", "千克", "4.50", "4.50", "10", "100"],
        ],
    ...
    [
        "012", "务普公司", "A001", "2019/12/11", "aioverg",
        [
            ["橙子", "A0014", "千克", "2.50", "2.50", "10", "100"],
